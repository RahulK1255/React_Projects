...
function App() {
  ...
  return (
    <div
        className='w-full h-screen flex flex-warp justify-center items-center bg-cover bg-no-repeat'
        style={{
          backgroundImage: `url('https://wallpapercave.com/wp/wp9223806.jpg?')`,
               }}
    >
